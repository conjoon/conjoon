...
Ext.define('Ext.package.Entry', {count:0, loaded:false, constructor:function(name) {
  ...
  var metadata = this.metadata, files = metadata && metadata.files, manifest = Ext.manifest, loadOrder = manifest && manifest.loadOrder, paths = [], i, js = metadata.js;
  if (files && loadOrder) {
...
Ext.define('Ext.Package', {requires:['Ext.package.Entry'], singleton:true, isLoaded:function(pkgName) {
...
}, _entryMap:{}, _usesMap:null, _packagesMap:null, _loadQueue:[], _loading:false, _advance:function() {
